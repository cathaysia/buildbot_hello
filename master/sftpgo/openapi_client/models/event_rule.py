...
class EventRule(BaseModel):
    ...
    actions: Optional[conlist(EventAction)] = None
    __properties = [
        "id",
        "name",
        "status",
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EventRule:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EventRule:
        """Create an instance of EventRule from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EventRule.parse_obj(obj)

        _obj = EventRule.parse_obj(
            {
                "id": obj.get("id"),
                "name": obj.get("name"),
                ...
                "actions": [
                    EventAction.from_dict(_item) for _item in obj.get("actions")
                ]
