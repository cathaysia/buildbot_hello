...
class WebDAVServiceStatus(BaseModel):
    """
    WebDAVServiceStatus
    """

    is_active: Optional[StrictBool] = None
    bindings: Optional[conlist(WebDAVBinding)] = None
    __properties = ["is_active", "bindings"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WebDAVServiceStatus:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WebDAVServiceStatus:
        """Create an instance of WebDAVServiceStatus from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WebDAVServiceStatus.parse_obj(obj)

        _obj = WebDAVServiceStatus.parse_obj(
            {
                "is_active": obj.get("is_active"),
                "bindings": [
                    WebDAVBinding.from_dict(_item) for _item in obj.get("bindings")
                ]
