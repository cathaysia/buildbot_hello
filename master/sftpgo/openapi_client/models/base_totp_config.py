...
class BaseTOTPConfig(BaseModel):
    """
    BaseTOTPConfig
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BaseTOTPConfig:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BaseTOTPConfig:
        """Create an instance of BaseTOTPConfig from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BaseTOTPConfig.parse_obj(obj)

        _obj = BaseTOTPConfig.parse_obj(
            {
