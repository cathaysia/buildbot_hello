...
class FsProviders(int, Enum):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FsProviders:
        """Create an instance of FsProviders from a JSON string"""
        return FsProviders(json.loads(json_str))
