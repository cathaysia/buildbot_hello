...
class DataProviderStatus(BaseModel):
    ...
    __properties = ["is_active", "driver", "error"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DataProviderStatus:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DataProviderStatus:
        """Create an instance of DataProviderStatus from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DataProviderStatus.parse_obj(obj)

        _obj = DataProviderStatus.parse_obj(
            {
