...
class EventTriggerTypes(int, Enum):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EventTriggerTypes:
        """Create an instance of EventTriggerTypes from a JSON string"""
        return EventTriggerTypes(json.loads(json_str))
