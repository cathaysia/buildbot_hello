...
class FTPPassivePortRange(BaseModel):
    """
    FTPPassivePortRange
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FTPPassivePortRange:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FTPPassivePortRange:
        """Create an instance of FTPPassivePortRange from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FTPPassivePortRange.parse_obj(obj)

        _obj = FTPPassivePortRange.parse_obj(
