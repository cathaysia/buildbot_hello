...
class HTTPPart(BaseModel):
    """
    HTTPPart
    """

    name: Optional[StrictStr] = None
    headers: Optional[conlist(KeyValue)] = Field(
        None,
    ...
    filepath: Optional[StrictStr] = Field(
        None, description="path to the file to be sent as an attachment"
    )
    body: Optional[StrictStr] = None
    __properties = ["name", "headers", "filepath", "body"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> HTTPPart:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> HTTPPart:
        """Create an instance of HTTPPart from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return HTTPPart.parse_obj(obj)

        _obj = HTTPPart.parse_obj(
            {
                "name": obj.get("name"),
