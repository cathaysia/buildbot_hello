...
class AdminTOTPConfig(BaseModel):
    """
    AdminTOTPConfig
    """
    ...
    __properties = ["enabled", "config_name", "secret"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AdminTOTPConfig:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AdminTOTPConfig:
        """Create an instance of AdminTOTPConfig from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AdminTOTPConfig.parse_obj(obj)

        _obj = AdminTOTPConfig.parse_obj(
            {
