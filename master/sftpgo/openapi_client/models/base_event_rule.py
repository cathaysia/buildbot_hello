...
class BaseEventRule(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BaseEventRule:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BaseEventRule:
        """Create an instance of BaseEventRule from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BaseEventRule.parse_obj(obj)

        _obj = BaseEventRule.parse_obj(
            {
                "id": obj.get("id"),
                "name": obj.get("name"),
