...
class RecoveryCode(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RecoveryCode:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RecoveryCode:
        """Create an instance of RecoveryCode from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RecoveryCode.parse_obj(obj)

        _obj = RecoveryCode.parse_obj(
            {
