...
class QuotaUsage(BaseModel):
    ...
    __properties = ["used_quota_size", "used_quota_files"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> QuotaUsage:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> QuotaUsage:
        """Create an instance of QuotaUsage from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return QuotaUsage.parse_obj(obj)

        _obj = QuotaUsage.parse_obj(
            {
