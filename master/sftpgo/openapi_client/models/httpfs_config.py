...
class HTTPFsConfig(BaseModel):
    ...
    skip_tls_verify: Optional[StrictBool] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> HTTPFsConfig:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> HTTPFsConfig:
        """Create an instance of HTTPFsConfig from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return HTTPFsConfig.parse_obj(obj)

        _obj = HTTPFsConfig.parse_obj(
            {
                ...
                "api_key": Secret.from_dict(obj.get("api_key"))
