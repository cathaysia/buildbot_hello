...
class SupportedProtocols(str, Enum):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SupportedProtocols:
        """Create an instance of SupportedProtocols from a JSON string"""
        return SupportedProtocols(json.loads(json_str))
