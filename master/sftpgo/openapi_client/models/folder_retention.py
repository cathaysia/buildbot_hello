...
class FolderRetention(BaseModel):
    """
    FolderRetention
    """
    ...
    retention: Optional[StrictInt] = Field(
        None,
    ...
    delete_empty_dirs: Optional[StrictBool] = Field(
        None, description="if enabled, empty directories will be deleted"
    )
    ignore_user_permissions: Optional[StrictBool] = Field(
        None,
    ...
    __properties = ["path", "retention", "delete_empty_dirs", "ignore_user_permissions"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FolderRetention:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FolderRetention:
        """Create an instance of FolderRetention from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FolderRetention.parse_obj(obj)

        _obj = FolderRetention.parse_obj(
            {
                "path": obj.get("path"),
                "retention": obj.get("retention"),
                "delete_empty_dirs": obj.get("delete_empty_dirs"),
                "ignore_user_permissions": obj.get("ignore_user_permissions"),
            }
        )
        return _obj
