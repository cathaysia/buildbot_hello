...
class SSHHostKey(BaseModel):
    ...
    algorithms: Optional[conlist(StrictStr)] = None
    __properties = ["path", "fingerprint", "algorithms"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SSHHostKey:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SSHHostKey:
        """Create an instance of SSHHostKey from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SSHHostKey.parse_obj(obj)

        _obj = SSHHostKey.parse_obj(
            {
                "path": obj.get("path"),
