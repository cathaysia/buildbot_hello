...
class AdminGroupMapping(BaseModel):
    """
    AdminGroupMapping
    """

    name: Optional[StrictStr] = Field(None, description="group name")
    options: Optional[AdminGroupMappingOptions] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AdminGroupMapping:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AdminGroupMapping:
        """Create an instance of AdminGroupMapping from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AdminGroupMapping.parse_obj(obj)

        _obj = AdminGroupMapping.parse_obj(
            {
                "name": obj.get("name"),
                "options": AdminGroupMappingOptions.from_dict(obj.get("options"))
