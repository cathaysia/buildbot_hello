...
class TransferQuotaUsage(BaseModel):
    """
    TransferQuotaUsage
    """

    used_upload_data_transfer: Optional[StrictInt] = Field(
        None, description="The value must be specified as bytes"
    )
    used_download_data_transfer: Optional[StrictInt] = Field(
        None, description="The value must be specified as bytes"
    )
    __properties = ["used_upload_data_transfer", "used_download_data_transfer"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TransferQuotaUsage:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TransferQuotaUsage:
        """Create an instance of TransferQuotaUsage from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TransferQuotaUsage.parse_obj(obj)

        _obj = TransferQuotaUsage.parse_obj(
            {
