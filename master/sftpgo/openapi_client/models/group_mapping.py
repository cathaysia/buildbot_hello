...
class GroupMapping(BaseModel):
    ...
    type: Optional[Union[StrictFloat, StrictInt]] = Field(
        None,
        description="Group type:   * `1` - Primary group   * `2` - Secondary group   * `3` - Membership only, no settings are inherited from this group type ",
    )
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GroupMapping:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GroupMapping:
        """Create an instance of GroupMapping from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GroupMapping.parse_obj(obj)

        _obj = GroupMapping.parse_obj(
