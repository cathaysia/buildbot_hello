...
class BaseUserFilters(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BaseUserFilters:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BaseUserFilters:
        """Create an instance of BaseUserFilters from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BaseUserFilters.parse_obj(obj)

        _obj = BaseUserFilters.parse_obj(
            {
