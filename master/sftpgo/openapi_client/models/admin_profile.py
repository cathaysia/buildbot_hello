...
class AdminProfile(BaseModel):
    ...
    __properties = ["email", "description", "allow_api_key_auth"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AdminProfile:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AdminProfile:
        """Create an instance of AdminProfile from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AdminProfile.parse_obj(obj)

        _obj = AdminProfile.parse_obj(
            {
                "email": obj.get("email"),
