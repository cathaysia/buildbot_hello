...
class DefenderEntry(BaseModel):
    ...
    ban_time: Optional[datetime] = Field(
        None,
    ...
    __properties = ["id", "ip", "score", "ban_time"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DefenderEntry:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DefenderEntry:
        """Create an instance of DefenderEntry from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DefenderEntry.parse_obj(obj)

        _obj = DefenderEntry.parse_obj(
            {
                "id": obj.get("id"),
                "ip": obj.get("ip"),
                "score": obj.get("score"),
