...
class SSHBinding(BaseModel):
    ...
    __properties = ["address", "port", "apply_proxy_config"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SSHBinding:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SSHBinding:
        """Create an instance of SSHBinding from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SSHBinding.parse_obj(obj)

        _obj = SSHBinding.parse_obj(
            {
