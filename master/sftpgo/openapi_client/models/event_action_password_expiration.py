...
class EventActionPasswordExpiration(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EventActionPasswordExpiration:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EventActionPasswordExpiration:
        """Create an instance of EventActionPasswordExpiration from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EventActionPasswordExpiration.parse_obj(obj)

        _obj = EventActionPasswordExpiration.parse_obj(
