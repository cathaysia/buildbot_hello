...
class TestMetadataApi(unittest.TestCase):
    ...
    def test_get_users_metadata_checks(self):
        """Test case for get_users_metadata_checks

        Get metadata checks  # noqa: E501
        """
        pass

    def test_start_user_metadata_check(self):
        """Test case for start_user_metadata_check
